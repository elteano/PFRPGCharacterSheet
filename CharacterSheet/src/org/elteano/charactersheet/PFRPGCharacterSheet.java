...
@ReportsCrashes(formKey = "dEtjaUVlM1ZrYVBDcnlnNHZJRzU0Z0E6MA", mode = ReportingInteractionMode.DIALOG, resToastText = R.string.crash_toast_text, // optional,
...
// defined, adds a user text field input with this text resource as a label
resDialogOkToast = R.string.crash_dialog_ok_toast // optional. displays a Toast
// message when the user accepts to send a report.
)
public class PFRPGCharacterSheet extends Application {
	@Override
